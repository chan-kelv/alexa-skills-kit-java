...
public final class Launcher {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        context.addServlet(new ServletHolder(createServlet(new NwQuizSpeechlet())), "/hello");
        context.addServlet(new ServletHolder(createServlet(new NwQuizSpeechlet())), "/session");
        server.start();
        server.join();
    }
